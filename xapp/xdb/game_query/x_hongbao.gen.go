...
func newXHongbao(db *gorm.DB, opts ...gen.DOOption) xHongbao {
	...
	_xHongbao.xHongbaoDo.UseModel(&game_model.XHongbao{})
...
type IXHongbaoDo interface {
	...
	Create(values ...*game_model.XHongbao) error
	CreateInBatches(values []*game_model.XHongbao, batchSize int) error
	Save(values ...*game_model.XHongbao) error
	First() (*game_model.XHongbao, error)
	Take() (*game_model.XHongbao, error)
	Last() (*game_model.XHongbao, error)
	Find() ([]*game_model.XHongbao, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XHongbao, err error)
	FindInBatches(result *[]*game_model.XHongbao, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XHongbao) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XHongbao, error)
	FirstOrCreate() (*game_model.XHongbao, error)
	FindByPage(offset int, limit int) (result []*game_model.XHongbao, count int64, err error)
...
func (x xHongbaoDo) Create(values ...*game_model.XHongbao) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoDo) CreateInBatches(values []*game_model.XHongbao, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xHongbaoDo) Save(values ...*game_model.XHongbao) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoDo) First() (*game_model.XHongbao, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XHongbao), nil
	}
}

func (x xHongbaoDo) Take() (*game_model.XHongbao, error) {
...
func (x xHongbaoDo) Last() (*game_model.XHongbao, error) {
...
func (x xHongbaoDo) Find() ([]*game_model.XHongbao, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XHongbao), err
}

func (x xHongbaoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XHongbao, err error) {
	buf := make([]*game_model.XHongbao, 0, batchSize)
...
func (x xHongbaoDo) FindInBatches(result *[]*game_model.XHongbao, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xHongbaoDo) FirstOrInit() (*game_model.XHongbao, error) {
...
func (x xHongbaoDo) FirstOrCreate() (*game_model.XHongbao, error) {
...
func (x xHongbaoDo) FindByPage(offset int, limit int) (result []*game_model.XHongbao, count int64, err error) {
...
func (x xHongbaoDo) Delete(models ...*game_model.XHongbao) (result gen.ResultInfo, err error) {
