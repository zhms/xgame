...
func newXSeller(db *gorm.DB, opts ...gen.DOOption) xSeller {
	...
	_xSeller.xSellerDo.UseModel(&game_model.XSeller{})
...
type IXSellerDo interface {
	...
	Unscoped() IXSellerDo
	Create(values ...*game_model.XSeller) error
	CreateInBatches(values []*game_model.XSeller, batchSize int) error
	Save(values ...*game_model.XSeller) error
	First() (*game_model.XSeller, error)
	Take() (*game_model.XSeller, error)
	Last() (*game_model.XSeller, error)
	Find() ([]*game_model.XSeller, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XSeller, err error)
	FindInBatches(result *[]*game_model.XSeller, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XSeller) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XSeller, error)
	FirstOrCreate() (*game_model.XSeller, error)
	FindByPage(offset int, limit int) (result []*game_model.XSeller, count int64, err error)
...
func (x xSellerDo) Create(values ...*game_model.XSeller) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xSellerDo) CreateInBatches(values []*game_model.XSeller, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xSellerDo) Save(values ...*game_model.XSeller) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xSellerDo) First() (*game_model.XSeller, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XSeller), nil
	}
}

func (x xSellerDo) Take() (*game_model.XSeller, error) {
...
func (x xSellerDo) Last() (*game_model.XSeller, error) {
...
func (x xSellerDo) Find() ([]*game_model.XSeller, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XSeller), err
}

func (x xSellerDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XSeller, err error) {
	buf := make([]*game_model.XSeller, 0, batchSize)
...
func (x xSellerDo) FindInBatches(result *[]*game_model.XSeller, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xSellerDo) FirstOrInit() (*game_model.XSeller, error) {
...
func (x xSellerDo) FirstOrCreate() (*game_model.XSeller, error) {
...
func (x xSellerDo) FindByPage(offset int, limit int) (result []*game_model.XSeller, count int64, err error) {
...
func (x xSellerDo) Delete(models ...*game_model.XSeller) (result gen.ResultInfo, err error) {
