...
func newXAdminLoginLog(db *gorm.DB, opts ...gen.DOOption) xAdminLoginLog {
	...
	_xAdminLoginLog.xAdminLoginLogDo.UseModel(&game_model.XAdminLoginLog{})
...
type IXAdminLoginLogDo interface {
	...
	Create(values ...*game_model.XAdminLoginLog) error
	CreateInBatches(values []*game_model.XAdminLoginLog, batchSize int) error
	Save(values ...*game_model.XAdminLoginLog) error
	First() (*game_model.XAdminLoginLog, error)
	Take() (*game_model.XAdminLoginLog, error)
	Last() (*game_model.XAdminLoginLog, error)
	Find() ([]*game_model.XAdminLoginLog, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminLoginLog, err error)
	FindInBatches(result *[]*game_model.XAdminLoginLog, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XAdminLoginLog) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XAdminLoginLog, error)
	FirstOrCreate() (*game_model.XAdminLoginLog, error)
	FindByPage(offset int, limit int) (result []*game_model.XAdminLoginLog, count int64, err error)
...
func (x xAdminLoginLogDo) Create(values ...*game_model.XAdminLoginLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminLoginLogDo) CreateInBatches(values []*game_model.XAdminLoginLog, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xAdminLoginLogDo) Save(values ...*game_model.XAdminLoginLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminLoginLogDo) First() (*game_model.XAdminLoginLog, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XAdminLoginLog), nil
	}
}

func (x xAdminLoginLogDo) Take() (*game_model.XAdminLoginLog, error) {
...
func (x xAdminLoginLogDo) Last() (*game_model.XAdminLoginLog, error) {
...
func (x xAdminLoginLogDo) Find() ([]*game_model.XAdminLoginLog, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XAdminLoginLog), err
}

func (x xAdminLoginLogDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminLoginLog, err error) {
	buf := make([]*game_model.XAdminLoginLog, 0, batchSize)
...
func (x xAdminLoginLogDo) FindInBatches(result *[]*game_model.XAdminLoginLog, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xAdminLoginLogDo) FirstOrInit() (*game_model.XAdminLoginLog, error) {
...
func (x xAdminLoginLogDo) FirstOrCreate() (*game_model.XAdminLoginLog, error) {
...
func (x xAdminLoginLogDo) FindByPage(offset int, limit int) (result []*game_model.XAdminLoginLog, count int64, err error) {
...
func (x xAdminLoginLogDo) Delete(models ...*game_model.XAdminLoginLog) (result gen.ResultInfo, err error) {
