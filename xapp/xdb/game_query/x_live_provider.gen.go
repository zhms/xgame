...
func newXLiveProvider(db *gorm.DB, opts ...gen.DOOption) xLiveProvider {
	...
	_xLiveProvider.xLiveProviderDo.UseModel(&game_model.XLiveProvider{})
...
type IXLiveProviderDo interface {
	...
	Create(values ...*game_model.XLiveProvider) error
	CreateInBatches(values []*game_model.XLiveProvider, batchSize int) error
	Save(values ...*game_model.XLiveProvider) error
	First() (*game_model.XLiveProvider, error)
	Take() (*game_model.XLiveProvider, error)
	Last() (*game_model.XLiveProvider, error)
	Find() ([]*game_model.XLiveProvider, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XLiveProvider, err error)
	FindInBatches(result *[]*game_model.XLiveProvider, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XLiveProvider) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XLiveProvider, error)
	FirstOrCreate() (*game_model.XLiveProvider, error)
	FindByPage(offset int, limit int) (result []*game_model.XLiveProvider, count int64, err error)
...
func (x xLiveProviderDo) Create(values ...*game_model.XLiveProvider) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveProviderDo) CreateInBatches(values []*game_model.XLiveProvider, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xLiveProviderDo) Save(values ...*game_model.XLiveProvider) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveProviderDo) First() (*game_model.XLiveProvider, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XLiveProvider), nil
	}
}

func (x xLiveProviderDo) Take() (*game_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) Last() (*game_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) Find() ([]*game_model.XLiveProvider, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XLiveProvider), err
}

func (x xLiveProviderDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XLiveProvider, err error) {
	buf := make([]*game_model.XLiveProvider, 0, batchSize)
...
func (x xLiveProviderDo) FindInBatches(result *[]*game_model.XLiveProvider, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xLiveProviderDo) FirstOrInit() (*game_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) FirstOrCreate() (*game_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) FindByPage(offset int, limit int) (result []*game_model.XLiveProvider, count int64, err error) {
...
func (x xLiveProviderDo) Delete(models ...*game_model.XLiveProvider) (result gen.ResultInfo, err error) {
