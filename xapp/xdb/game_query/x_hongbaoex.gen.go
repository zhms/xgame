...
func newXHongbaoex(db *gorm.DB, opts ...gen.DOOption) xHongbaoex {
	...
	_xHongbaoex.xHongbaoexDo.UseModel(&game_model.XHongbaoex{})
...
type IXHongbaoexDo interface {
	...
	Create(values ...*game_model.XHongbaoex) error
	CreateInBatches(values []*game_model.XHongbaoex, batchSize int) error
	Save(values ...*game_model.XHongbaoex) error
	First() (*game_model.XHongbaoex, error)
	Take() (*game_model.XHongbaoex, error)
	Last() (*game_model.XHongbaoex, error)
	Find() ([]*game_model.XHongbaoex, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XHongbaoex, err error)
	FindInBatches(result *[]*game_model.XHongbaoex, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XHongbaoex) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XHongbaoex, error)
	FirstOrCreate() (*game_model.XHongbaoex, error)
	FindByPage(offset int, limit int) (result []*game_model.XHongbaoex, count int64, err error)
...
func (x xHongbaoexDo) Create(values ...*game_model.XHongbaoex) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoexDo) CreateInBatches(values []*game_model.XHongbaoex, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xHongbaoexDo) Save(values ...*game_model.XHongbaoex) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoexDo) First() (*game_model.XHongbaoex, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XHongbaoex), nil
	}
}

func (x xHongbaoexDo) Take() (*game_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) Last() (*game_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) Find() ([]*game_model.XHongbaoex, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XHongbaoex), err
}

func (x xHongbaoexDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XHongbaoex, err error) {
	buf := make([]*game_model.XHongbaoex, 0, batchSize)
...
func (x xHongbaoexDo) FindInBatches(result *[]*game_model.XHongbaoex, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xHongbaoexDo) FirstOrInit() (*game_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) FirstOrCreate() (*game_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) FindByPage(offset int, limit int) (result []*game_model.XHongbaoex, count int64, err error) {
...
func (x xHongbaoexDo) Delete(models ...*game_model.XHongbaoex) (result gen.ResultInfo, err error) {
