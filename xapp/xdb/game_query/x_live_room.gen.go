...
func newXLiveRoom(db *gorm.DB, opts ...gen.DOOption) xLiveRoom {
	...
	_xLiveRoom.xLiveRoomDo.UseModel(&game_model.XLiveRoom{})
...
type IXLiveRoomDo interface {
	...
	Create(values ...*game_model.XLiveRoom) error
	CreateInBatches(values []*game_model.XLiveRoom, batchSize int) error
	Save(values ...*game_model.XLiveRoom) error
	First() (*game_model.XLiveRoom, error)
	Take() (*game_model.XLiveRoom, error)
	Last() (*game_model.XLiveRoom, error)
	Find() ([]*game_model.XLiveRoom, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XLiveRoom, err error)
	FindInBatches(result *[]*game_model.XLiveRoom, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XLiveRoom) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XLiveRoom, error)
	FirstOrCreate() (*game_model.XLiveRoom, error)
	FindByPage(offset int, limit int) (result []*game_model.XLiveRoom, count int64, err error)
...
func (x xLiveRoomDo) Create(values ...*game_model.XLiveRoom) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveRoomDo) CreateInBatches(values []*game_model.XLiveRoom, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xLiveRoomDo) Save(values ...*game_model.XLiveRoom) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveRoomDo) First() (*game_model.XLiveRoom, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XLiveRoom), nil
	}
}

func (x xLiveRoomDo) Take() (*game_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) Last() (*game_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) Find() ([]*game_model.XLiveRoom, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XLiveRoom), err
}

func (x xLiveRoomDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XLiveRoom, err error) {
	buf := make([]*game_model.XLiveRoom, 0, batchSize)
...
func (x xLiveRoomDo) FindInBatches(result *[]*game_model.XLiveRoom, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xLiveRoomDo) FirstOrInit() (*game_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) FirstOrCreate() (*game_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) FindByPage(offset int, limit int) (result []*game_model.XLiveRoom, count int64, err error) {
...
func (x xLiveRoomDo) Delete(models ...*game_model.XLiveRoom) (result gen.ResultInfo, err error) {
