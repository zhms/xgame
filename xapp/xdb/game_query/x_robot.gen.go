...
func newXRobot(db *gorm.DB, opts ...gen.DOOption) xRobot {
	...
	_xRobot.xRobotDo.UseModel(&game_model.XRobot{})
...
type IXRobotDo interface {
	...
	Unscoped() IXRobotDo
	Create(values ...*game_model.XRobot) error
	CreateInBatches(values []*game_model.XRobot, batchSize int) error
	Save(values ...*game_model.XRobot) error
	First() (*game_model.XRobot, error)
	Take() (*game_model.XRobot, error)
	Last() (*game_model.XRobot, error)
	Find() ([]*game_model.XRobot, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XRobot, err error)
	FindInBatches(result *[]*game_model.XRobot, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XRobot) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XRobot, error)
	FirstOrCreate() (*game_model.XRobot, error)
	FindByPage(offset int, limit int) (result []*game_model.XRobot, count int64, err error)
...
func (x xRobotDo) Create(values ...*game_model.XRobot) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xRobotDo) CreateInBatches(values []*game_model.XRobot, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xRobotDo) Save(values ...*game_model.XRobot) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xRobotDo) First() (*game_model.XRobot, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XRobot), nil
	}
}

func (x xRobotDo) Take() (*game_model.XRobot, error) {
...
func (x xRobotDo) Last() (*game_model.XRobot, error) {
...
func (x xRobotDo) Find() ([]*game_model.XRobot, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XRobot), err
}

func (x xRobotDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XRobot, err error) {
	buf := make([]*game_model.XRobot, 0, batchSize)
...
func (x xRobotDo) FindInBatches(result *[]*game_model.XRobot, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xRobotDo) FirstOrInit() (*game_model.XRobot, error) {
...
func (x xRobotDo) FirstOrCreate() (*game_model.XRobot, error) {
...
func (x xRobotDo) FindByPage(offset int, limit int) (result []*game_model.XRobot, count int64, err error) {
...
func (x xRobotDo) Delete(models ...*game_model.XRobot) (result gen.ResultInfo, err error) {
