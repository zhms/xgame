...
func newXHostSeller(db *gorm.DB, opts ...gen.DOOption) xHostSeller {
	...
	_xHostSeller.xHostSellerDo.UseModel(&game_model.XHostSeller{})
...
type IXHostSellerDo interface {
	...
	Create(values ...*game_model.XHostSeller) error
	CreateInBatches(values []*game_model.XHostSeller, batchSize int) error
	Save(values ...*game_model.XHostSeller) error
	First() (*game_model.XHostSeller, error)
	Take() (*game_model.XHostSeller, error)
	Last() (*game_model.XHostSeller, error)
	Find() ([]*game_model.XHostSeller, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XHostSeller, err error)
	FindInBatches(result *[]*game_model.XHostSeller, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XHostSeller) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XHostSeller, error)
	FirstOrCreate() (*game_model.XHostSeller, error)
	FindByPage(offset int, limit int) (result []*game_model.XHostSeller, count int64, err error)
...
func (x xHostSellerDo) Create(values ...*game_model.XHostSeller) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHostSellerDo) CreateInBatches(values []*game_model.XHostSeller, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xHostSellerDo) Save(values ...*game_model.XHostSeller) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHostSellerDo) First() (*game_model.XHostSeller, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XHostSeller), nil
	}
}

func (x xHostSellerDo) Take() (*game_model.XHostSeller, error) {
...
func (x xHostSellerDo) Last() (*game_model.XHostSeller, error) {
...
func (x xHostSellerDo) Find() ([]*game_model.XHostSeller, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XHostSeller), err
}

func (x xHostSellerDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XHostSeller, err error) {
	buf := make([]*game_model.XHostSeller, 0, batchSize)
...
func (x xHostSellerDo) FindInBatches(result *[]*game_model.XHostSeller, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xHostSellerDo) FirstOrInit() (*game_model.XHostSeller, error) {
...
func (x xHostSellerDo) FirstOrCreate() (*game_model.XHostSeller, error) {
...
func (x xHostSellerDo) FindByPage(offset int, limit int) (result []*game_model.XHostSeller, count int64, err error) {
...
func (x xHostSellerDo) Delete(models ...*game_model.XHostSeller) (result gen.ResultInfo, err error) {
