...
func newXChatDatum(db *gorm.DB, opts ...gen.DOOption) xChatDatum {
	...
	_xChatDatum.xChatDatumDo.UseModel(&game_model.XChatDatum{})
...
type IXChatDatumDo interface {
	...
	Create(values ...*game_model.XChatDatum) error
	CreateInBatches(values []*game_model.XChatDatum, batchSize int) error
	Save(values ...*game_model.XChatDatum) error
	First() (*game_model.XChatDatum, error)
	Take() (*game_model.XChatDatum, error)
	Last() (*game_model.XChatDatum, error)
	Find() ([]*game_model.XChatDatum, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XChatDatum, err error)
	FindInBatches(result *[]*game_model.XChatDatum, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XChatDatum) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XChatDatum, error)
	FirstOrCreate() (*game_model.XChatDatum, error)
	FindByPage(offset int, limit int) (result []*game_model.XChatDatum, count int64, err error)
...
func (x xChatDatumDo) Create(values ...*game_model.XChatDatum) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDatumDo) CreateInBatches(values []*game_model.XChatDatum, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xChatDatumDo) Save(values ...*game_model.XChatDatum) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDatumDo) First() (*game_model.XChatDatum, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XChatDatum), nil
	}
}

func (x xChatDatumDo) Take() (*game_model.XChatDatum, error) {
...
func (x xChatDatumDo) Last() (*game_model.XChatDatum, error) {
...
func (x xChatDatumDo) Find() ([]*game_model.XChatDatum, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XChatDatum), err
}

func (x xChatDatumDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XChatDatum, err error) {
	buf := make([]*game_model.XChatDatum, 0, batchSize)
...
func (x xChatDatumDo) FindInBatches(result *[]*game_model.XChatDatum, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xChatDatumDo) FirstOrInit() (*game_model.XChatDatum, error) {
...
func (x xChatDatumDo) FirstOrCreate() (*game_model.XChatDatum, error) {
...
func (x xChatDatumDo) FindByPage(offset int, limit int) (result []*game_model.XChatDatum, count int64, err error) {
...
func (x xChatDatumDo) Delete(models ...*game_model.XChatDatum) (result gen.ResultInfo, err error) {
