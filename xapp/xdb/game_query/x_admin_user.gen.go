...
func newXAdminUser(db *gorm.DB, opts ...gen.DOOption) xAdminUser {
	...
	_xAdminUser.xAdminUserDo.UseModel(&game_model.XAdminUser{})
...
type IXAdminUserDo interface {
	...
	Create(values ...*game_model.XAdminUser) error
	CreateInBatches(values []*game_model.XAdminUser, batchSize int) error
	Save(values ...*game_model.XAdminUser) error
	First() (*game_model.XAdminUser, error)
	Take() (*game_model.XAdminUser, error)
	Last() (*game_model.XAdminUser, error)
	Find() ([]*game_model.XAdminUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminUser, err error)
	FindInBatches(result *[]*game_model.XAdminUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XAdminUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XAdminUser, error)
	FirstOrCreate() (*game_model.XAdminUser, error)
	FindByPage(offset int, limit int) (result []*game_model.XAdminUser, count int64, err error)
...
func (x xAdminUserDo) Create(values ...*game_model.XAdminUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminUserDo) CreateInBatches(values []*game_model.XAdminUser, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xAdminUserDo) Save(values ...*game_model.XAdminUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminUserDo) First() (*game_model.XAdminUser, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XAdminUser), nil
	}
}

func (x xAdminUserDo) Take() (*game_model.XAdminUser, error) {
...
func (x xAdminUserDo) Last() (*game_model.XAdminUser, error) {
...
func (x xAdminUserDo) Find() ([]*game_model.XAdminUser, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XAdminUser), err
}

func (x xAdminUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminUser, err error) {
	buf := make([]*game_model.XAdminUser, 0, batchSize)
...
func (x xAdminUserDo) FindInBatches(result *[]*game_model.XAdminUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xAdminUserDo) FirstOrInit() (*game_model.XAdminUser, error) {
...
func (x xAdminUserDo) FirstOrCreate() (*game_model.XAdminUser, error) {
...
func (x xAdminUserDo) FindByPage(offset int, limit int) (result []*game_model.XAdminUser, count int64, err error) {
...
func (x xAdminUserDo) Delete(models ...*game_model.XAdminUser) (result gen.ResultInfo, err error) {
