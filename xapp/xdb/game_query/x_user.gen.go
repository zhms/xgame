...
func newXUser(db *gorm.DB, opts ...gen.DOOption) xUser {
	...
	_xUser.xUserDo.UseModel(&game_model.XUser{})
...
type IXUserDo interface {
	...
	Unscoped() IXUserDo
	Create(values ...*game_model.XUser) error
	CreateInBatches(values []*game_model.XUser, batchSize int) error
	Save(values ...*game_model.XUser) error
	First() (*game_model.XUser, error)
	Take() (*game_model.XUser, error)
	Last() (*game_model.XUser, error)
	Find() ([]*game_model.XUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XUser, err error)
	FindInBatches(result *[]*game_model.XUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XUser, error)
	FirstOrCreate() (*game_model.XUser, error)
	FindByPage(offset int, limit int) (result []*game_model.XUser, count int64, err error)
...
func (x xUserDo) Create(values ...*game_model.XUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xUserDo) CreateInBatches(values []*game_model.XUser, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xUserDo) Save(values ...*game_model.XUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xUserDo) First() (*game_model.XUser, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XUser), nil
	}
}

func (x xUserDo) Take() (*game_model.XUser, error) {
...
func (x xUserDo) Last() (*game_model.XUser, error) {
...
func (x xUserDo) Find() ([]*game_model.XUser, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XUser), err
}

func (x xUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XUser, err error) {
	buf := make([]*game_model.XUser, 0, batchSize)
...
func (x xUserDo) FindInBatches(result *[]*game_model.XUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xUserDo) FirstOrInit() (*game_model.XUser, error) {
...
func (x xUserDo) FirstOrCreate() (*game_model.XUser, error) {
...
func (x xUserDo) FindByPage(offset int, limit int) (result []*game_model.XUser, count int64, err error) {
...
func (x xUserDo) Delete(models ...*game_model.XUser) (result gen.ResultInfo, err error) {
