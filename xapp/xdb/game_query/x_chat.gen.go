...
func newXChat(db *gorm.DB, opts ...gen.DOOption) xChat {
	...
	_xChat.xChatDo.UseModel(&game_model.XChat{})
...
type IXChatDo interface {
	...
	Unscoped() IXChatDo
	Create(values ...*game_model.XChat) error
	CreateInBatches(values []*game_model.XChat, batchSize int) error
	Save(values ...*game_model.XChat) error
	First() (*game_model.XChat, error)
	Take() (*game_model.XChat, error)
	Last() (*game_model.XChat, error)
	Find() ([]*game_model.XChat, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XChat, err error)
	FindInBatches(result *[]*game_model.XChat, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XChat) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XChat, error)
	FirstOrCreate() (*game_model.XChat, error)
	FindByPage(offset int, limit int) (result []*game_model.XChat, count int64, err error)
...
func (x xChatDo) Create(values ...*game_model.XChat) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDo) CreateInBatches(values []*game_model.XChat, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xChatDo) Save(values ...*game_model.XChat) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDo) First() (*game_model.XChat, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XChat), nil
	}
}

func (x xChatDo) Take() (*game_model.XChat, error) {
...
func (x xChatDo) Last() (*game_model.XChat, error) {
...
func (x xChatDo) Find() ([]*game_model.XChat, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XChat), err
}

func (x xChatDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XChat, err error) {
	buf := make([]*game_model.XChat, 0, batchSize)
...
func (x xChatDo) FindInBatches(result *[]*game_model.XChat, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xChatDo) FirstOrInit() (*game_model.XChat, error) {
...
func (x xChatDo) FirstOrCreate() (*game_model.XChat, error) {
...
func (x xChatDo) FindByPage(offset int, limit int) (result []*game_model.XChat, count int64, err error) {
...
func (x xChatDo) Delete(models ...*game_model.XChat) (result gen.ResultInfo, err error) {
