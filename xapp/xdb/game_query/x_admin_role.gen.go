...
func newXAdminRole(db *gorm.DB, opts ...gen.DOOption) xAdminRole {
	...
	_xAdminRole.xAdminRoleDo.UseModel(&game_model.XAdminRole{})
...
type IXAdminRoleDo interface {
	...
	Create(values ...*game_model.XAdminRole) error
	CreateInBatches(values []*game_model.XAdminRole, batchSize int) error
	Save(values ...*game_model.XAdminRole) error
	First() (*game_model.XAdminRole, error)
	Take() (*game_model.XAdminRole, error)
	Last() (*game_model.XAdminRole, error)
	Find() ([]*game_model.XAdminRole, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminRole, err error)
	FindInBatches(result *[]*game_model.XAdminRole, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XAdminRole) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XAdminRole, error)
	FirstOrCreate() (*game_model.XAdminRole, error)
	FindByPage(offset int, limit int) (result []*game_model.XAdminRole, count int64, err error)
...
func (x xAdminRoleDo) Create(values ...*game_model.XAdminRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminRoleDo) CreateInBatches(values []*game_model.XAdminRole, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xAdminRoleDo) Save(values ...*game_model.XAdminRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminRoleDo) First() (*game_model.XAdminRole, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XAdminRole), nil
	}
}

func (x xAdminRoleDo) Take() (*game_model.XAdminRole, error) {
...
func (x xAdminRoleDo) Last() (*game_model.XAdminRole, error) {
...
func (x xAdminRoleDo) Find() ([]*game_model.XAdminRole, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XAdminRole), err
}

func (x xAdminRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminRole, err error) {
	buf := make([]*game_model.XAdminRole, 0, batchSize)
...
func (x xAdminRoleDo) FindInBatches(result *[]*game_model.XAdminRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xAdminRoleDo) FirstOrInit() (*game_model.XAdminRole, error) {
...
func (x xAdminRoleDo) FirstOrCreate() (*game_model.XAdminRole, error) {
...
func (x xAdminRoleDo) FindByPage(offset int, limit int) (result []*game_model.XAdminRole, count int64, err error) {
...
func (x xAdminRoleDo) Delete(models ...*game_model.XAdminRole) (result gen.ResultInfo, err error) {
