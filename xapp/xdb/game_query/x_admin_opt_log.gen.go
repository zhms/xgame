...
func newXAdminOptLog(db *gorm.DB, opts ...gen.DOOption) xAdminOptLog {
	...
	_xAdminOptLog.xAdminOptLogDo.UseModel(&game_model.XAdminOptLog{})
...
type IXAdminOptLogDo interface {
	...
	Create(values ...*game_model.XAdminOptLog) error
	CreateInBatches(values []*game_model.XAdminOptLog, batchSize int) error
	Save(values ...*game_model.XAdminOptLog) error
	First() (*game_model.XAdminOptLog, error)
	Take() (*game_model.XAdminOptLog, error)
	Last() (*game_model.XAdminOptLog, error)
	Find() ([]*game_model.XAdminOptLog, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminOptLog, err error)
	FindInBatches(result *[]*game_model.XAdminOptLog, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XAdminOptLog) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XAdminOptLog, error)
	FirstOrCreate() (*game_model.XAdminOptLog, error)
	FindByPage(offset int, limit int) (result []*game_model.XAdminOptLog, count int64, err error)
...
func (x xAdminOptLogDo) Create(values ...*game_model.XAdminOptLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminOptLogDo) CreateInBatches(values []*game_model.XAdminOptLog, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xAdminOptLogDo) Save(values ...*game_model.XAdminOptLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminOptLogDo) First() (*game_model.XAdminOptLog, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XAdminOptLog), nil
	}
}

func (x xAdminOptLogDo) Take() (*game_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) Last() (*game_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) Find() ([]*game_model.XAdminOptLog, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XAdminOptLog), err
}

func (x xAdminOptLogDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XAdminOptLog, err error) {
	buf := make([]*game_model.XAdminOptLog, 0, batchSize)
...
func (x xAdminOptLogDo) FindInBatches(result *[]*game_model.XAdminOptLog, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xAdminOptLogDo) FirstOrInit() (*game_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) FirstOrCreate() (*game_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) FindByPage(offset int, limit int) (result []*game_model.XAdminOptLog, count int64, err error) {
...
func (x xAdminOptLogDo) Delete(models ...*game_model.XAdminOptLog) (result gen.ResultInfo, err error) {
