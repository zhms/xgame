...
func newXStatistic(db *gorm.DB, opts ...gen.DOOption) xStatistic {
	...
	_xStatistic.xStatisticDo.UseModel(&game_model.XStatistic{})
...
type IXStatisticDo interface {
	...
	Create(values ...*game_model.XStatistic) error
	CreateInBatches(values []*game_model.XStatistic, batchSize int) error
	Save(values ...*game_model.XStatistic) error
	First() (*game_model.XStatistic, error)
	Take() (*game_model.XStatistic, error)
	Last() (*game_model.XStatistic, error)
	Find() ([]*game_model.XStatistic, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XStatistic, err error)
	FindInBatches(result *[]*game_model.XStatistic, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XStatistic) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XStatistic, error)
	FirstOrCreate() (*game_model.XStatistic, error)
	FindByPage(offset int, limit int) (result []*game_model.XStatistic, count int64, err error)
...
func (x xStatisticDo) Create(values ...*game_model.XStatistic) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xStatisticDo) CreateInBatches(values []*game_model.XStatistic, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xStatisticDo) Save(values ...*game_model.XStatistic) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xStatisticDo) First() (*game_model.XStatistic, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XStatistic), nil
	}
}

func (x xStatisticDo) Take() (*game_model.XStatistic, error) {
...
func (x xStatisticDo) Last() (*game_model.XStatistic, error) {
...
func (x xStatisticDo) Find() ([]*game_model.XStatistic, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XStatistic), err
}

func (x xStatisticDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XStatistic, err error) {
	buf := make([]*game_model.XStatistic, 0, batchSize)
...
func (x xStatisticDo) FindInBatches(result *[]*game_model.XStatistic, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xStatisticDo) FirstOrInit() (*game_model.XStatistic, error) {
...
func (x xStatisticDo) FirstOrCreate() (*game_model.XStatistic, error) {
...
func (x xStatisticDo) FindByPage(offset int, limit int) (result []*game_model.XStatistic, count int64, err error) {
...
func (x xStatisticDo) Delete(models ...*game_model.XStatistic) (result gen.ResultInfo, err error) {
