...
func newXChatBanIP(db *gorm.DB, opts ...gen.DOOption) xChatBanIP {
	...
	_xChatBanIP.xChatBanIPDo.UseModel(&game_model.XChatBanIP{})
...
type IXChatBanIPDo interface {
	...
	Create(values ...*game_model.XChatBanIP) error
	CreateInBatches(values []*game_model.XChatBanIP, batchSize int) error
	Save(values ...*game_model.XChatBanIP) error
	First() (*game_model.XChatBanIP, error)
	Take() (*game_model.XChatBanIP, error)
	Last() (*game_model.XChatBanIP, error)
	Find() ([]*game_model.XChatBanIP, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XChatBanIP, err error)
	FindInBatches(result *[]*game_model.XChatBanIP, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XChatBanIP) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XChatBanIP, error)
	FirstOrCreate() (*game_model.XChatBanIP, error)
	FindByPage(offset int, limit int) (result []*game_model.XChatBanIP, count int64, err error)
...
func (x xChatBanIPDo) Create(values ...*game_model.XChatBanIP) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatBanIPDo) CreateInBatches(values []*game_model.XChatBanIP, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xChatBanIPDo) Save(values ...*game_model.XChatBanIP) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatBanIPDo) First() (*game_model.XChatBanIP, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XChatBanIP), nil
	}
}

func (x xChatBanIPDo) Take() (*game_model.XChatBanIP, error) {
...
func (x xChatBanIPDo) Last() (*game_model.XChatBanIP, error) {
...
func (x xChatBanIPDo) Find() ([]*game_model.XChatBanIP, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XChatBanIP), err
}

func (x xChatBanIPDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XChatBanIP, err error) {
	buf := make([]*game_model.XChatBanIP, 0, batchSize)
...
func (x xChatBanIPDo) FindInBatches(result *[]*game_model.XChatBanIP, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xChatBanIPDo) FirstOrInit() (*game_model.XChatBanIP, error) {
...
func (x xChatBanIPDo) FirstOrCreate() (*game_model.XChatBanIP, error) {
...
func (x xChatBanIPDo) FindByPage(offset int, limit int) (result []*game_model.XChatBanIP, count int64, err error) {
...
func (x xChatBanIPDo) Delete(models ...*game_model.XChatBanIP) (result gen.ResultInfo, err error) {
