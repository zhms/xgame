...
func newXKv(db *gorm.DB, opts ...gen.DOOption) xKv {
	...
	_xKv.xKvDo.UseModel(&game_model.XKv{})
...
type IXKvDo interface {
	...
	Unscoped() IXKvDo
	Create(values ...*game_model.XKv) error
	CreateInBatches(values []*game_model.XKv, batchSize int) error
	Save(values ...*game_model.XKv) error
	First() (*game_model.XKv, error)
	Take() (*game_model.XKv, error)
	Last() (*game_model.XKv, error)
	Find() ([]*game_model.XKv, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XKv, err error)
	FindInBatches(result *[]*game_model.XKv, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*game_model.XKv) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*game_model.XKv, error)
	FirstOrCreate() (*game_model.XKv, error)
	FindByPage(offset int, limit int) (result []*game_model.XKv, count int64, err error)
...
func (x xKvDo) Create(values ...*game_model.XKv) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xKvDo) CreateInBatches(values []*game_model.XKv, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xKvDo) Save(values ...*game_model.XKv) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xKvDo) First() (*game_model.XKv, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*game_model.XKv), nil
	}
}

func (x xKvDo) Take() (*game_model.XKv, error) {
...
func (x xKvDo) Last() (*game_model.XKv, error) {
...
func (x xKvDo) Find() ([]*game_model.XKv, error) {
	result, err := x.DO.Find()
	return result.([]*game_model.XKv), err
}

func (x xKvDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*game_model.XKv, err error) {
	buf := make([]*game_model.XKv, 0, batchSize)
...
func (x xKvDo) FindInBatches(result *[]*game_model.XKv, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xKvDo) FirstOrInit() (*game_model.XKv, error) {
...
func (x xKvDo) FirstOrCreate() (*game_model.XKv, error) {
...
func (x xKvDo) FindByPage(offset int, limit int) (result []*game_model.XKv, count int64, err error) {
...
func (x xKvDo) Delete(models ...*game_model.XKv) (result gen.ResultInfo, err error) {
