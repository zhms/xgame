...
func newXUser(db *gorm.DB, opts ...gen.DOOption) xUser {
	...
	_xUser.xUserDo.UseModel(&order_model.XUser{})
...
type IXUserDo interface {
	...
	Unscoped() IXUserDo
	Create(values ...*order_model.XUser) error
	CreateInBatches(values []*order_model.XUser, batchSize int) error
	Save(values ...*order_model.XUser) error
	First() (*order_model.XUser, error)
	Take() (*order_model.XUser, error)
	Last() (*order_model.XUser, error)
	Find() ([]*order_model.XUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XUser, err error)
	FindInBatches(result *[]*order_model.XUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XUser, error)
	FirstOrCreate() (*order_model.XUser, error)
	FindByPage(offset int, limit int) (result []*order_model.XUser, count int64, err error)
...
func (x xUserDo) Create(values ...*order_model.XUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xUserDo) CreateInBatches(values []*order_model.XUser, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xUserDo) Save(values ...*order_model.XUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xUserDo) First() (*order_model.XUser, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XUser), nil
	}
}

func (x xUserDo) Take() (*order_model.XUser, error) {
...
func (x xUserDo) Last() (*order_model.XUser, error) {
...
func (x xUserDo) Find() ([]*order_model.XUser, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XUser), err
}

func (x xUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XUser, err error) {
	buf := make([]*order_model.XUser, 0, batchSize)
...
func (x xUserDo) FindInBatches(result *[]*order_model.XUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xUserDo) FirstOrInit() (*order_model.XUser, error) {
...
func (x xUserDo) FirstOrCreate() (*order_model.XUser, error) {
...
func (x xUserDo) FindByPage(offset int, limit int) (result []*order_model.XUser, count int64, err error) {
...
func (x xUserDo) Delete(models ...*order_model.XUser) (result gen.ResultInfo, err error) {
