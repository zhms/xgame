...
func newXKv(db *gorm.DB, opts ...gen.DOOption) xKv {
	...
	_xKv.xKvDo.UseModel(&order_model.XKv{})
...
type IXKvDo interface {
	...
	Unscoped() IXKvDo
	Create(values ...*order_model.XKv) error
	CreateInBatches(values []*order_model.XKv, batchSize int) error
	Save(values ...*order_model.XKv) error
	First() (*order_model.XKv, error)
	Take() (*order_model.XKv, error)
	Last() (*order_model.XKv, error)
	Find() ([]*order_model.XKv, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XKv, err error)
	FindInBatches(result *[]*order_model.XKv, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XKv) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XKv, error)
	FirstOrCreate() (*order_model.XKv, error)
	FindByPage(offset int, limit int) (result []*order_model.XKv, count int64, err error)
...
func (x xKvDo) Create(values ...*order_model.XKv) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xKvDo) CreateInBatches(values []*order_model.XKv, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xKvDo) Save(values ...*order_model.XKv) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xKvDo) First() (*order_model.XKv, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XKv), nil
	}
}

func (x xKvDo) Take() (*order_model.XKv, error) {
...
func (x xKvDo) Last() (*order_model.XKv, error) {
...
func (x xKvDo) Find() ([]*order_model.XKv, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XKv), err
}

func (x xKvDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XKv, err error) {
	buf := make([]*order_model.XKv, 0, batchSize)
...
func (x xKvDo) FindInBatches(result *[]*order_model.XKv, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xKvDo) FirstOrInit() (*order_model.XKv, error) {
...
func (x xKvDo) FirstOrCreate() (*order_model.XKv, error) {
...
func (x xKvDo) FindByPage(offset int, limit int) (result []*order_model.XKv, count int64, err error) {
...
func (x xKvDo) Delete(models ...*order_model.XKv) (result gen.ResultInfo, err error) {
