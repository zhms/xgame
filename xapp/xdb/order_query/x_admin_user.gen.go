...
func newXAdminUser(db *gorm.DB, opts ...gen.DOOption) xAdminUser {
	...
	_xAdminUser.xAdminUserDo.UseModel(&order_model.XAdminUser{})
...
type IXAdminUserDo interface {
	...
	Create(values ...*order_model.XAdminUser) error
	CreateInBatches(values []*order_model.XAdminUser, batchSize int) error
	Save(values ...*order_model.XAdminUser) error
	First() (*order_model.XAdminUser, error)
	Take() (*order_model.XAdminUser, error)
	Last() (*order_model.XAdminUser, error)
	Find() ([]*order_model.XAdminUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XAdminUser, err error)
	FindInBatches(result *[]*order_model.XAdminUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XAdminUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XAdminUser, error)
	FirstOrCreate() (*order_model.XAdminUser, error)
	FindByPage(offset int, limit int) (result []*order_model.XAdminUser, count int64, err error)
...
func (x xAdminUserDo) Create(values ...*order_model.XAdminUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminUserDo) CreateInBatches(values []*order_model.XAdminUser, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xAdminUserDo) Save(values ...*order_model.XAdminUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminUserDo) First() (*order_model.XAdminUser, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XAdminUser), nil
	}
}

func (x xAdminUserDo) Take() (*order_model.XAdminUser, error) {
...
func (x xAdminUserDo) Last() (*order_model.XAdminUser, error) {
...
func (x xAdminUserDo) Find() ([]*order_model.XAdminUser, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XAdminUser), err
}

func (x xAdminUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XAdminUser, err error) {
	buf := make([]*order_model.XAdminUser, 0, batchSize)
...
func (x xAdminUserDo) FindInBatches(result *[]*order_model.XAdminUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xAdminUserDo) FirstOrInit() (*order_model.XAdminUser, error) {
...
func (x xAdminUserDo) FirstOrCreate() (*order_model.XAdminUser, error) {
...
func (x xAdminUserDo) FindByPage(offset int, limit int) (result []*order_model.XAdminUser, count int64, err error) {
...
func (x xAdminUserDo) Delete(models ...*order_model.XAdminUser) (result gen.ResultInfo, err error) {
