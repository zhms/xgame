...
func newXLiveProvider(db *gorm.DB, opts ...gen.DOOption) xLiveProvider {
	...
	_xLiveProvider.xLiveProviderDo.UseModel(&order_model.XLiveProvider{})
...
type IXLiveProviderDo interface {
	...
	Create(values ...*order_model.XLiveProvider) error
	CreateInBatches(values []*order_model.XLiveProvider, batchSize int) error
	Save(values ...*order_model.XLiveProvider) error
	First() (*order_model.XLiveProvider, error)
	Take() (*order_model.XLiveProvider, error)
	Last() (*order_model.XLiveProvider, error)
	Find() ([]*order_model.XLiveProvider, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XLiveProvider, err error)
	FindInBatches(result *[]*order_model.XLiveProvider, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XLiveProvider) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XLiveProvider, error)
	FirstOrCreate() (*order_model.XLiveProvider, error)
	FindByPage(offset int, limit int) (result []*order_model.XLiveProvider, count int64, err error)
...
func (x xLiveProviderDo) Create(values ...*order_model.XLiveProvider) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveProviderDo) CreateInBatches(values []*order_model.XLiveProvider, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xLiveProviderDo) Save(values ...*order_model.XLiveProvider) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveProviderDo) First() (*order_model.XLiveProvider, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XLiveProvider), nil
	}
}

func (x xLiveProviderDo) Take() (*order_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) Last() (*order_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) Find() ([]*order_model.XLiveProvider, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XLiveProvider), err
}

func (x xLiveProviderDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XLiveProvider, err error) {
	buf := make([]*order_model.XLiveProvider, 0, batchSize)
...
func (x xLiveProviderDo) FindInBatches(result *[]*order_model.XLiveProvider, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xLiveProviderDo) FirstOrInit() (*order_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) FirstOrCreate() (*order_model.XLiveProvider, error) {
...
func (x xLiveProviderDo) FindByPage(offset int, limit int) (result []*order_model.XLiveProvider, count int64, err error) {
...
func (x xLiveProviderDo) Delete(models ...*order_model.XLiveProvider) (result gen.ResultInfo, err error) {
