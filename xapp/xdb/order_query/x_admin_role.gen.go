...
func newXAdminRole(db *gorm.DB, opts ...gen.DOOption) xAdminRole {
	...
	_xAdminRole.xAdminRoleDo.UseModel(&order_model.XAdminRole{})
...
type IXAdminRoleDo interface {
	...
	Create(values ...*order_model.XAdminRole) error
	CreateInBatches(values []*order_model.XAdminRole, batchSize int) error
	Save(values ...*order_model.XAdminRole) error
	First() (*order_model.XAdminRole, error)
	Take() (*order_model.XAdminRole, error)
	Last() (*order_model.XAdminRole, error)
	Find() ([]*order_model.XAdminRole, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XAdminRole, err error)
	FindInBatches(result *[]*order_model.XAdminRole, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XAdminRole) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XAdminRole, error)
	FirstOrCreate() (*order_model.XAdminRole, error)
	FindByPage(offset int, limit int) (result []*order_model.XAdminRole, count int64, err error)
...
func (x xAdminRoleDo) Create(values ...*order_model.XAdminRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminRoleDo) CreateInBatches(values []*order_model.XAdminRole, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xAdminRoleDo) Save(values ...*order_model.XAdminRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminRoleDo) First() (*order_model.XAdminRole, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XAdminRole), nil
	}
}

func (x xAdminRoleDo) Take() (*order_model.XAdminRole, error) {
...
func (x xAdminRoleDo) Last() (*order_model.XAdminRole, error) {
...
func (x xAdminRoleDo) Find() ([]*order_model.XAdminRole, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XAdminRole), err
}

func (x xAdminRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XAdminRole, err error) {
	buf := make([]*order_model.XAdminRole, 0, batchSize)
...
func (x xAdminRoleDo) FindInBatches(result *[]*order_model.XAdminRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xAdminRoleDo) FirstOrInit() (*order_model.XAdminRole, error) {
...
func (x xAdminRoleDo) FirstOrCreate() (*order_model.XAdminRole, error) {
...
func (x xAdminRoleDo) FindByPage(offset int, limit int) (result []*order_model.XAdminRole, count int64, err error) {
...
func (x xAdminRoleDo) Delete(models ...*order_model.XAdminRole) (result gen.ResultInfo, err error) {
