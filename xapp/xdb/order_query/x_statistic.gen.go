...
func newXStatistic(db *gorm.DB, opts ...gen.DOOption) xStatistic {
	...
	_xStatistic.xStatisticDo.UseModel(&order_model.XStatistic{})
...
type IXStatisticDo interface {
	...
	Create(values ...*order_model.XStatistic) error
	CreateInBatches(values []*order_model.XStatistic, batchSize int) error
	Save(values ...*order_model.XStatistic) error
	First() (*order_model.XStatistic, error)
	Take() (*order_model.XStatistic, error)
	Last() (*order_model.XStatistic, error)
	Find() ([]*order_model.XStatistic, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XStatistic, err error)
	FindInBatches(result *[]*order_model.XStatistic, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XStatistic) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XStatistic, error)
	FirstOrCreate() (*order_model.XStatistic, error)
	FindByPage(offset int, limit int) (result []*order_model.XStatistic, count int64, err error)
...
func (x xStatisticDo) Create(values ...*order_model.XStatistic) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xStatisticDo) CreateInBatches(values []*order_model.XStatistic, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xStatisticDo) Save(values ...*order_model.XStatistic) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xStatisticDo) First() (*order_model.XStatistic, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XStatistic), nil
	}
}

func (x xStatisticDo) Take() (*order_model.XStatistic, error) {
...
func (x xStatisticDo) Last() (*order_model.XStatistic, error) {
...
func (x xStatisticDo) Find() ([]*order_model.XStatistic, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XStatistic), err
}

func (x xStatisticDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XStatistic, err error) {
	buf := make([]*order_model.XStatistic, 0, batchSize)
...
func (x xStatisticDo) FindInBatches(result *[]*order_model.XStatistic, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xStatisticDo) FirstOrInit() (*order_model.XStatistic, error) {
...
func (x xStatisticDo) FirstOrCreate() (*order_model.XStatistic, error) {
...
func (x xStatisticDo) FindByPage(offset int, limit int) (result []*order_model.XStatistic, count int64, err error) {
...
func (x xStatisticDo) Delete(models ...*order_model.XStatistic) (result gen.ResultInfo, err error) {
