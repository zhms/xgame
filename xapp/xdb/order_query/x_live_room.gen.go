...
func newXLiveRoom(db *gorm.DB, opts ...gen.DOOption) xLiveRoom {
	...
	_xLiveRoom.xLiveRoomDo.UseModel(&order_model.XLiveRoom{})
...
type IXLiveRoomDo interface {
	...
	Create(values ...*order_model.XLiveRoom) error
	CreateInBatches(values []*order_model.XLiveRoom, batchSize int) error
	Save(values ...*order_model.XLiveRoom) error
	First() (*order_model.XLiveRoom, error)
	Take() (*order_model.XLiveRoom, error)
	Last() (*order_model.XLiveRoom, error)
	Find() ([]*order_model.XLiveRoom, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XLiveRoom, err error)
	FindInBatches(result *[]*order_model.XLiveRoom, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XLiveRoom) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XLiveRoom, error)
	FirstOrCreate() (*order_model.XLiveRoom, error)
	FindByPage(offset int, limit int) (result []*order_model.XLiveRoom, count int64, err error)
...
func (x xLiveRoomDo) Create(values ...*order_model.XLiveRoom) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveRoomDo) CreateInBatches(values []*order_model.XLiveRoom, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xLiveRoomDo) Save(values ...*order_model.XLiveRoom) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xLiveRoomDo) First() (*order_model.XLiveRoom, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XLiveRoom), nil
	}
}

func (x xLiveRoomDo) Take() (*order_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) Last() (*order_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) Find() ([]*order_model.XLiveRoom, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XLiveRoom), err
}

func (x xLiveRoomDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XLiveRoom, err error) {
	buf := make([]*order_model.XLiveRoom, 0, batchSize)
...
func (x xLiveRoomDo) FindInBatches(result *[]*order_model.XLiveRoom, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xLiveRoomDo) FirstOrInit() (*order_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) FirstOrCreate() (*order_model.XLiveRoom, error) {
...
func (x xLiveRoomDo) FindByPage(offset int, limit int) (result []*order_model.XLiveRoom, count int64, err error) {
...
func (x xLiveRoomDo) Delete(models ...*order_model.XLiveRoom) (result gen.ResultInfo, err error) {
