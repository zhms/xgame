...
func newXRobot(db *gorm.DB, opts ...gen.DOOption) xRobot {
	...
	_xRobot.xRobotDo.UseModel(&order_model.XRobot{})
...
type IXRobotDo interface {
	...
	Unscoped() IXRobotDo
	Create(values ...*order_model.XRobot) error
	CreateInBatches(values []*order_model.XRobot, batchSize int) error
	Save(values ...*order_model.XRobot) error
	First() (*order_model.XRobot, error)
	Take() (*order_model.XRobot, error)
	Last() (*order_model.XRobot, error)
	Find() ([]*order_model.XRobot, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XRobot, err error)
	FindInBatches(result *[]*order_model.XRobot, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XRobot) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XRobot, error)
	FirstOrCreate() (*order_model.XRobot, error)
	FindByPage(offset int, limit int) (result []*order_model.XRobot, count int64, err error)
...
func (x xRobotDo) Create(values ...*order_model.XRobot) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xRobotDo) CreateInBatches(values []*order_model.XRobot, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xRobotDo) Save(values ...*order_model.XRobot) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xRobotDo) First() (*order_model.XRobot, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XRobot), nil
	}
}

func (x xRobotDo) Take() (*order_model.XRobot, error) {
...
func (x xRobotDo) Last() (*order_model.XRobot, error) {
...
func (x xRobotDo) Find() ([]*order_model.XRobot, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XRobot), err
}

func (x xRobotDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XRobot, err error) {
	buf := make([]*order_model.XRobot, 0, batchSize)
...
func (x xRobotDo) FindInBatches(result *[]*order_model.XRobot, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xRobotDo) FirstOrInit() (*order_model.XRobot, error) {
...
func (x xRobotDo) FirstOrCreate() (*order_model.XRobot, error) {
...
func (x xRobotDo) FindByPage(offset int, limit int) (result []*order_model.XRobot, count int64, err error) {
...
func (x xRobotDo) Delete(models ...*order_model.XRobot) (result gen.ResultInfo, err error) {
