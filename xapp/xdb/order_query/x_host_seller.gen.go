...
func newXHostSeller(db *gorm.DB, opts ...gen.DOOption) xHostSeller {
	...
	_xHostSeller.xHostSellerDo.UseModel(&order_model.XHostSeller{})
...
type IXHostSellerDo interface {
	...
	Create(values ...*order_model.XHostSeller) error
	CreateInBatches(values []*order_model.XHostSeller, batchSize int) error
	Save(values ...*order_model.XHostSeller) error
	First() (*order_model.XHostSeller, error)
	Take() (*order_model.XHostSeller, error)
	Last() (*order_model.XHostSeller, error)
	Find() ([]*order_model.XHostSeller, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XHostSeller, err error)
	FindInBatches(result *[]*order_model.XHostSeller, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XHostSeller) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XHostSeller, error)
	FirstOrCreate() (*order_model.XHostSeller, error)
	FindByPage(offset int, limit int) (result []*order_model.XHostSeller, count int64, err error)
...
func (x xHostSellerDo) Create(values ...*order_model.XHostSeller) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHostSellerDo) CreateInBatches(values []*order_model.XHostSeller, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xHostSellerDo) Save(values ...*order_model.XHostSeller) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHostSellerDo) First() (*order_model.XHostSeller, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XHostSeller), nil
	}
}

func (x xHostSellerDo) Take() (*order_model.XHostSeller, error) {
...
func (x xHostSellerDo) Last() (*order_model.XHostSeller, error) {
...
func (x xHostSellerDo) Find() ([]*order_model.XHostSeller, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XHostSeller), err
}

func (x xHostSellerDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XHostSeller, err error) {
	buf := make([]*order_model.XHostSeller, 0, batchSize)
...
func (x xHostSellerDo) FindInBatches(result *[]*order_model.XHostSeller, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xHostSellerDo) FirstOrInit() (*order_model.XHostSeller, error) {
...
func (x xHostSellerDo) FirstOrCreate() (*order_model.XHostSeller, error) {
...
func (x xHostSellerDo) FindByPage(offset int, limit int) (result []*order_model.XHostSeller, count int64, err error) {
...
func (x xHostSellerDo) Delete(models ...*order_model.XHostSeller) (result gen.ResultInfo, err error) {
