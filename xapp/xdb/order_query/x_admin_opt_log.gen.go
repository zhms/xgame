...
func newXAdminOptLog(db *gorm.DB, opts ...gen.DOOption) xAdminOptLog {
	...
	_xAdminOptLog.xAdminOptLogDo.UseModel(&order_model.XAdminOptLog{})
...
type IXAdminOptLogDo interface {
	...
	Create(values ...*order_model.XAdminOptLog) error
	CreateInBatches(values []*order_model.XAdminOptLog, batchSize int) error
	Save(values ...*order_model.XAdminOptLog) error
	First() (*order_model.XAdminOptLog, error)
	Take() (*order_model.XAdminOptLog, error)
	Last() (*order_model.XAdminOptLog, error)
	Find() ([]*order_model.XAdminOptLog, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XAdminOptLog, err error)
	FindInBatches(result *[]*order_model.XAdminOptLog, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XAdminOptLog) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XAdminOptLog, error)
	FirstOrCreate() (*order_model.XAdminOptLog, error)
	FindByPage(offset int, limit int) (result []*order_model.XAdminOptLog, count int64, err error)
...
func (x xAdminOptLogDo) Create(values ...*order_model.XAdminOptLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminOptLogDo) CreateInBatches(values []*order_model.XAdminOptLog, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xAdminOptLogDo) Save(values ...*order_model.XAdminOptLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xAdminOptLogDo) First() (*order_model.XAdminOptLog, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XAdminOptLog), nil
	}
}

func (x xAdminOptLogDo) Take() (*order_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) Last() (*order_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) Find() ([]*order_model.XAdminOptLog, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XAdminOptLog), err
}

func (x xAdminOptLogDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XAdminOptLog, err error) {
	buf := make([]*order_model.XAdminOptLog, 0, batchSize)
...
func (x xAdminOptLogDo) FindInBatches(result *[]*order_model.XAdminOptLog, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xAdminOptLogDo) FirstOrInit() (*order_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) FirstOrCreate() (*order_model.XAdminOptLog, error) {
...
func (x xAdminOptLogDo) FindByPage(offset int, limit int) (result []*order_model.XAdminOptLog, count int64, err error) {
...
func (x xAdminOptLogDo) Delete(models ...*order_model.XAdminOptLog) (result gen.ResultInfo, err error) {
