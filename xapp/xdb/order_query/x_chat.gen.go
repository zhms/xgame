...
func newXChat(db *gorm.DB, opts ...gen.DOOption) xChat {
	...
	_xChat.xChatDo.UseModel(&order_model.XChat{})
...
type IXChatDo interface {
	...
	Unscoped() IXChatDo
	Create(values ...*order_model.XChat) error
	CreateInBatches(values []*order_model.XChat, batchSize int) error
	Save(values ...*order_model.XChat) error
	First() (*order_model.XChat, error)
	Take() (*order_model.XChat, error)
	Last() (*order_model.XChat, error)
	Find() ([]*order_model.XChat, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XChat, err error)
	FindInBatches(result *[]*order_model.XChat, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XChat) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XChat, error)
	FirstOrCreate() (*order_model.XChat, error)
	FindByPage(offset int, limit int) (result []*order_model.XChat, count int64, err error)
...
func (x xChatDo) Create(values ...*order_model.XChat) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDo) CreateInBatches(values []*order_model.XChat, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xChatDo) Save(values ...*order_model.XChat) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDo) First() (*order_model.XChat, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XChat), nil
	}
}

func (x xChatDo) Take() (*order_model.XChat, error) {
...
func (x xChatDo) Last() (*order_model.XChat, error) {
...
func (x xChatDo) Find() ([]*order_model.XChat, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XChat), err
}

func (x xChatDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XChat, err error) {
	buf := make([]*order_model.XChat, 0, batchSize)
...
func (x xChatDo) FindInBatches(result *[]*order_model.XChat, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xChatDo) FirstOrInit() (*order_model.XChat, error) {
...
func (x xChatDo) FirstOrCreate() (*order_model.XChat, error) {
...
func (x xChatDo) FindByPage(offset int, limit int) (result []*order_model.XChat, count int64, err error) {
...
func (x xChatDo) Delete(models ...*order_model.XChat) (result gen.ResultInfo, err error) {
