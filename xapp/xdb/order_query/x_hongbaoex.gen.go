...
func newXHongbaoex(db *gorm.DB, opts ...gen.DOOption) xHongbaoex {
	...
	_xHongbaoex.xHongbaoexDo.UseModel(&order_model.XHongbaoex{})
...
type IXHongbaoexDo interface {
	...
	Create(values ...*order_model.XHongbaoex) error
	CreateInBatches(values []*order_model.XHongbaoex, batchSize int) error
	Save(values ...*order_model.XHongbaoex) error
	First() (*order_model.XHongbaoex, error)
	Take() (*order_model.XHongbaoex, error)
	Last() (*order_model.XHongbaoex, error)
	Find() ([]*order_model.XHongbaoex, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XHongbaoex, err error)
	FindInBatches(result *[]*order_model.XHongbaoex, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XHongbaoex) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XHongbaoex, error)
	FirstOrCreate() (*order_model.XHongbaoex, error)
	FindByPage(offset int, limit int) (result []*order_model.XHongbaoex, count int64, err error)
...
func (x xHongbaoexDo) Create(values ...*order_model.XHongbaoex) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoexDo) CreateInBatches(values []*order_model.XHongbaoex, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xHongbaoexDo) Save(values ...*order_model.XHongbaoex) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoexDo) First() (*order_model.XHongbaoex, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XHongbaoex), nil
	}
}

func (x xHongbaoexDo) Take() (*order_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) Last() (*order_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) Find() ([]*order_model.XHongbaoex, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XHongbaoex), err
}

func (x xHongbaoexDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XHongbaoex, err error) {
	buf := make([]*order_model.XHongbaoex, 0, batchSize)
...
func (x xHongbaoexDo) FindInBatches(result *[]*order_model.XHongbaoex, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xHongbaoexDo) FirstOrInit() (*order_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) FirstOrCreate() (*order_model.XHongbaoex, error) {
...
func (x xHongbaoexDo) FindByPage(offset int, limit int) (result []*order_model.XHongbaoex, count int64, err error) {
...
func (x xHongbaoexDo) Delete(models ...*order_model.XHongbaoex) (result gen.ResultInfo, err error) {
