...
func newXChatDatum(db *gorm.DB, opts ...gen.DOOption) xChatDatum {
	...
	_xChatDatum.xChatDatumDo.UseModel(&order_model.XChatDatum{})
...
type IXChatDatumDo interface {
	...
	Create(values ...*order_model.XChatDatum) error
	CreateInBatches(values []*order_model.XChatDatum, batchSize int) error
	Save(values ...*order_model.XChatDatum) error
	First() (*order_model.XChatDatum, error)
	Take() (*order_model.XChatDatum, error)
	Last() (*order_model.XChatDatum, error)
	Find() ([]*order_model.XChatDatum, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XChatDatum, err error)
	FindInBatches(result *[]*order_model.XChatDatum, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XChatDatum) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XChatDatum, error)
	FirstOrCreate() (*order_model.XChatDatum, error)
	FindByPage(offset int, limit int) (result []*order_model.XChatDatum, count int64, err error)
...
func (x xChatDatumDo) Create(values ...*order_model.XChatDatum) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDatumDo) CreateInBatches(values []*order_model.XChatDatum, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xChatDatumDo) Save(values ...*order_model.XChatDatum) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xChatDatumDo) First() (*order_model.XChatDatum, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XChatDatum), nil
	}
}

func (x xChatDatumDo) Take() (*order_model.XChatDatum, error) {
...
func (x xChatDatumDo) Last() (*order_model.XChatDatum, error) {
...
func (x xChatDatumDo) Find() ([]*order_model.XChatDatum, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XChatDatum), err
}

func (x xChatDatumDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XChatDatum, err error) {
	buf := make([]*order_model.XChatDatum, 0, batchSize)
...
func (x xChatDatumDo) FindInBatches(result *[]*order_model.XChatDatum, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xChatDatumDo) FirstOrInit() (*order_model.XChatDatum, error) {
...
func (x xChatDatumDo) FirstOrCreate() (*order_model.XChatDatum, error) {
...
func (x xChatDatumDo) FindByPage(offset int, limit int) (result []*order_model.XChatDatum, count int64, err error) {
...
func (x xChatDatumDo) Delete(models ...*order_model.XChatDatum) (result gen.ResultInfo, err error) {
