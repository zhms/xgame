...
func newXHongbao(db *gorm.DB, opts ...gen.DOOption) xHongbao {
	...
	_xHongbao.xHongbaoDo.UseModel(&order_model.XHongbao{})
...
type IXHongbaoDo interface {
	...
	Create(values ...*order_model.XHongbao) error
	CreateInBatches(values []*order_model.XHongbao, batchSize int) error
	Save(values ...*order_model.XHongbao) error
	First() (*order_model.XHongbao, error)
	Take() (*order_model.XHongbao, error)
	Last() (*order_model.XHongbao, error)
	Find() ([]*order_model.XHongbao, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XHongbao, err error)
	FindInBatches(result *[]*order_model.XHongbao, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*order_model.XHongbao) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*order_model.XHongbao, error)
	FirstOrCreate() (*order_model.XHongbao, error)
	FindByPage(offset int, limit int) (result []*order_model.XHongbao, count int64, err error)
...
func (x xHongbaoDo) Create(values ...*order_model.XHongbao) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoDo) CreateInBatches(values []*order_model.XHongbao, batchSize int) error {
	return x.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (x xHongbaoDo) Save(values ...*order_model.XHongbao) error {
	if len(values) == 0 {
		return nil
	}
...
func (x xHongbaoDo) First() (*order_model.XHongbao, error) {
	if result, err := x.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*order_model.XHongbao), nil
	}
}

func (x xHongbaoDo) Take() (*order_model.XHongbao, error) {
...
func (x xHongbaoDo) Last() (*order_model.XHongbao, error) {
...
func (x xHongbaoDo) Find() ([]*order_model.XHongbao, error) {
	result, err := x.DO.Find()
	return result.([]*order_model.XHongbao), err
}

func (x xHongbaoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*order_model.XHongbao, err error) {
	buf := make([]*order_model.XHongbao, 0, batchSize)
...
func (x xHongbaoDo) FindInBatches(result *[]*order_model.XHongbao, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (x xHongbaoDo) FirstOrInit() (*order_model.XHongbao, error) {
...
func (x xHongbaoDo) FirstOrCreate() (*order_model.XHongbao, error) {
...
func (x xHongbaoDo) FindByPage(offset int, limit int) (result []*order_model.XHongbao, count int64, err error) {
...
func (x xHongbaoDo) Delete(models ...*order_model.XHongbao) (result gen.ResultInfo, err error) {
